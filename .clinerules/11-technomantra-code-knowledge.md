...
- IMPORT about.html -> styles.css, about.css, site-chrome.js, script.js
- IMPORT certifications.html -> styles.css, certifications.css, certifications-banner.css, site-chrome.js
- IMPORT contact-us.html -> styles.css, contact-us.css, contact-us-overrides.css, site-chrome.js, script.js
- IMPORT industries.html -> styles.css, industries.css, site-chrome.js, script.js, industries.js
- IMPORT products.html -> styles.css, products.css, products-motion.css, site-chrome.js, products-motion.js
- IMPORT why-choose-us.html -> styles.css, why-choose-us.css, site-chrome.js

## Database references
- DB site-chrome.js -> which

## Symbols
- SYMBOL industries.js: showAll, count, update
- SYMBOL products-motion.js: add, count, frame
- SYMBOL script.js: closeModal, animateCounters, updateCount, openQuoteModal, closeQuoteModal

## UI/style selectors
- UI index.html: #navMenu, #mobileToggle, #home, #watchVideoBtn, #about, #industries, #standard, #why-us, #products, #prevProduct, #productsSlider, #nextProduct, #certifications, #quote
- UI styles.css: #eaf2ff, #d0e2ff, #ffffff, #f8fafc, .container, .section-badge, .section-title, .wave-accent, .btn, .btn-primary, .btn-secondary, #cbd5e1, .btn-circle, .top-bar
...
- UI products.css: .products-page, #fff, .applications, .p-wrap, #e7faff, #ffffff70, #e8faff, #abdffa, #ffffff22, .p-cta, .main-header, .nav-menu
- UI products.html: #navMenu, #mobileToggle, #range, #contact, .products-page, .top-bar, .container, .top-bar-contact, .top-bar-item, .top-bar-message, .fas, .fa-phone-alt, .fa-envelope, .top-bar-social
- UI why-choose-us.css: .why-page, .why-wrap, #fff, .reasons, .trust, .work, .stories, #cceafb, #f6fcff, #a9ddfa, #ffffff70, .story-grid, #def7ff, #b8e9ff
- UI why-choose-us.html: #navMenu, #mobileToggle, #reasons, #contact, .why-page, .top-bar, .container, .top-bar-contact, .top-bar-item, .top-bar-message, .fas, .fa-phone-alt, .fa-envelope, .fa-envelope-open
